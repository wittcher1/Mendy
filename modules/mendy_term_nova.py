...
def identificar_acao(entrada):
    ...
    return 'comando'  # Por padrão, tenta como comando
...
def pensar_sobre_pergunta(entrada):
    ...
    if os.path.exists(downloads_path):
        ...
        return "Não encontrei a pasta Downloads. Use o comando: termux-setup-storage"
...
def mendy_loop():
    print("🖥️  Nova Mendy-Term Iniciada. Digite algo (ou 'exit' para sair).")
    while True:
        entrada = input("$ ")
